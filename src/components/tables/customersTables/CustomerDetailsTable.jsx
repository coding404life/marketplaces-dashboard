...
function createData(channelName, subscriptionType, subscriptionPrice, subscriptionPlan, dateOfPurchase) {
  return {
    channelName,
    subscriptionType,
    subscriptionPrice,
...
const rows = [
  createData('Hawker', 'yearly', '$100/yearly', 'yearly/plan', '01-01-2023'),
  createData('Hawker', 'yearly', '$100/yearly', 'yearly/plan', '01-01-2023'),
  createData('Hawker', 'yearly', '$100/yearly', 'yearly/plan', '01-01-2023'),
  createData('Hawker', 'yearly', '$100/yearly', 'yearly/plan', '01-01-2023'),
  createData('Hawker', 'yearly', '$100/yearly', 'yearly/plan', '01-01-2023'),
              ...
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row) => (
                  <TableRow hover role="cell" tabIndex={-1} key={row.transactions}>
                    <TableCell padding="none">{row.channelName}</TableCell>
                    <TableCell align="left">{row.subscriptionType}</TableCell>
                    <TableCell align="left">{row.subscriptionPrice}</TableCell>
